...
namespace SubSonic.WebUtility
{
    ...
    public class RESTfullUrl
    {
        ...
        {
            return (RESTCommand)Utility.StringToEnum(typeof(RESTCommand), command);
        }
        ...
        {
            return (RESTReturnType)Utility.StringToEnum(typeof(RESTReturnType), format);
        }
        ...
        private void ParseQueryString()
        {
            ...
            if(qMark > 0)
            {
                string qString = Strings.Clip(_rawUrl, qMark);
